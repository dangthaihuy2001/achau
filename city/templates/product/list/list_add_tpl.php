                ...
                <div id="scroll-right">
                    <?php if (isset($config['product'][$type]['images_list']) && $config['product'][$type]['images_list'] == true) { ?>
                        <div class="card card-primary card-outline text-sm">
                            ...
                            <div class="card-body">
                                <?php if (isset($config['product'][$type]['city_list']) && $config['product'][$type]['city_list'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-6">
                                        <label class="d-block" for="id_city">Danh mục tags:</label>
                                        <?= $func->get_tags2(@$item['id'], 'city_group', 'product_list', 'tinh-thanh',$type) ?>
                                    </div>
                                <?php } ?>
                                <?php
