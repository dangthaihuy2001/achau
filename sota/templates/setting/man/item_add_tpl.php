        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['setting']['ungdung']) && $config['setting']['ungdung'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="ungdung">Link ứng dụng:</label>
                            <input type="text" class="form-control" name="data[options][ungdung]" id="ungdung"
                                placeholder="Link ứng dụng" value="<?= $options['ungdung'] ?>">
                        </div>
                    <?php } ?>
