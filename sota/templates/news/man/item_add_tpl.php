                            ...
                            <div class="form-group-category row">
                                ...
                                <?php if(isset($config['news'][$type]['luachon']) && $config['news'][$type]['luachon'] == true) { ?>
                                    <div class="form-group col-xl-6 col-sm-4">
                                        ...
                                        <select name="data[luachon]" id="" class=" select2">
                                            <option value="all" <?=$item['luachon']=='all'?'selected':''?>>Tất cả</option>
                                            <option value="user" <?=$item['luachon']=='user'?'selected':''?>>Tài khoản khách</option>
                                        </select>
                                    </div>
                                <?php } ?>
                            </div>
