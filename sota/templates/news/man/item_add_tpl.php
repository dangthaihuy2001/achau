                        ...
                        <div class="card card-primary card-outline text-sm">
                            ...
                            <div class="card-body">
                                <div class="form-group-category row">
                                    ...
                                    <?php } ?>
                                    <?php if (isset($config['news'][$type]['luachon']) && $config['news'][$type]['luachon'] == true) { ?>
                                        <div class="form-group col-xl-6 col-sm-4">
                                            <label class="d-block" for="id_tags">Người nhận:</label>
                                            <select name="data[city]" id="" class=" select2">
                                                <option value="1" <?= $item['city'] == '1' ? 'selected' : '' ?>>Tất cả</option>
                                                <?php foreach ($func->getList('city') as $key => $value) { ?>
                                                    <option value="<?= $value['id'] ?>" <?= $item['luachon'] == $value['ten'] ? 'selected' : '' ?>><?= $value['ten'] ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    <?php } ?>
