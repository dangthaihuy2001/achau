        ...
        <nav class="mt-3">
            <ul data-accordion="true" class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm"
                ...
                <?php if (isset($config['newsletter'])) { ?>
                    ...
                    ?>
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        <a class="nav-link <?= $active ?>" href="#" title="Quản lý thông báo">
                            <img style="margin-right: 5px;" src="../../assets/images/Category.png" alt="">
                            <p>
                                Quản lý thông báo
                                <i class="right fas fa-angle-left"></i>
                ...
                <?php if (isset($config['user']['active']) && $config['user']['active'] == true) { ?>
                    ...
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        ...
                        <ul class="nav nav-treeview">
                            <?php if (isset($config['permission']) && $config['permission'] == true && $func->check_permission_user() == 3) {
                                $active = "";
                            ...
                            <?php if (isset($config['user']['admin']) && $config['user']['admin'] == true && $func->check_permission_user() == 3) {
                                ...
                                <li class="nav-item"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=man_admin" title="Tài khoản admin">
                                        <i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Tài khoản admin (Tỉnh)</p>
                                    </a></li>
                            <?php } ?>
                            <?php if (isset($config['user']['admin_seller']) && $config['user']['admin_seller'] == true && ($func->check_permission_user() == 3 || $func->check_permission_user() == 2)) { ?>
                                <?php $active = "";
                                if ($act == 'man_admin_seller' || $act == 'add_admin_seller' || $act == 'edit_admin_seller') $active = "active" ?>
                                <li class="nav-item"><a class="nav-link <?= $active ?>" href="index.php?com=user&act=man_admin_seller" title="Tài khoản bán hàng">
                                        <i class="nav-icon text-sm far fa-caret-square-right"></i>
                                        <p>Tài khoản bán hàng</p>
                                    </a></li>
                            <?php } ?>
                            <?php if (isset($config['user']['visitor']) && $config['user']['visitor'] == true && $func->check_permission_user() > 1) {
                                $active = "";
