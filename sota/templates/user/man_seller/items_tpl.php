...
$linkAdd = "index.php?com=user&act=add_admin_seller&p=" . $curPage;
$linkEdit = "index.php?com=user&act=edit_admin_seller&p=" . $curPage;
$linkDelete = "index.php?com=user&act=delete_admin_seller&p=" . $curPage;
$linkFilter = "index.php?com=user&act=man_admin_seller&p=" . $curPage;
?>
...
<section class="content">
    ...
    <div class="card-footer form-group-category text-sm bg-light row">
        <?php if (isset($_SESSION[$login_admin]['active']) && $_SESSION[$login_admin]['id'] == '116') { ?>
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title">Danh sách tài khoản admin bán hàng</h3>
        </div>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">Cảnh báo</th>
                    ...
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) { ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <a class="text-dark" href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>&id_city=<?= $items[$i]['id_city'] ?>&id_wards=<?= $items[$i]['id_wards'] ?>" title="<?= $items[$i]['username'] ?>"><?= $items[$i]['username'] ?></a>
                                </td>
                                <td class="align-middle">
                                ...
                                <td class="align-middle text-center text-md text-nowrap">
                                    <a class="text-primary mr-2" href="<?= $linkEdit ?>&id=<?= $items[$i]['id'] ?>&id_city=<?= $items[$i]['id_city'] ?>&id_wards=<?= $items[$i]['id_wards'] ?>" title="Chỉnh sửa"><i class="fas fa-edit"></i></a>
