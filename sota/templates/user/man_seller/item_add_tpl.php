<?php
$linkMan = "index.php?com=user&act=man_admin_seller&p=" . $curPage;
$linkSave = "index.php?com=user&act=save_admin_seller&p=" . $curPage;
?>
<!-- Content Header -->
			...
			<div class="card-body">
				<div class="row">
					...
					<div class="form-group col-md-4">
						...
						<input type="text" class="form-control" name="data[thoihan]" id="thoihan" placeholder="Thời hạn" value="<?= (@$item['thoihan']) ? date('d/m/Y', @$item['thoihan']) : ""; ?>" readonly>
					</div>
					<div class="form-group col-md-4">
					...
					<div class="form-group col-md-12">
						...
						<input type="text" class="form-control" name="data[toado]" id="toado" placeholder="Link google map" value="<?= @$item['toado'] ?>">
					</div>
					<div class="form-group col-md-12">
						<label for="toado_iframe">iframe map:</label>
						<textarea name="data[toado_iframe]" class="form-control" id="toado_iframe" placeholder="iframe map" rows="5"><?= htmlspecialchars_decode($item['toado_iframe']) ?></textarea>
					</div>
				</div>
