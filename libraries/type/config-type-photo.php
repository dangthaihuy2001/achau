...
$config['photo']['photo_static'][$nametype]['img_type'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|webp|WEBP';
...
$config['photo']['man_photo'][$nametype]['width_photo'] = 1267;
$config['photo']['man_photo'][$nametype]['height_photo'] = 385;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '1267x385x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';

$nametype = "slide2";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow2";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
...
$nametype = "banner-uudai";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Banner ưu đãi";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = true;
...
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '200x80x1';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
...
$nametype = "thanh-tuu";
$config['photo']['man_photo'][$nametype]['title_main_photo'] = "Thành tựu";
$config['photo']['man_photo'][$nametype]['number_photo'] = 1;
$config['photo']['man_photo'][$nametype]['images_photo'] = true;
$config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
$config['photo']['man_photo'][$nametype]['link_photo'] = false;
$config['photo']['man_photo'][$nametype]['tieude_photo'] = true;
$config['photo']['man_photo'][$nametype]['mota_photo'] = true;
$config['photo']['man_photo'][$nametype]['width_photo'] = 64;
$config['photo']['man_photo'][$nametype]['height_photo'] = 64;
$config['photo']['man_photo'][$nametype]['thumb_photo'] = '64x64x2';
$config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
