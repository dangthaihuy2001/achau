...
<body>
    ...
    <div id="wrapper">
        ...
        <div>
            ...
            ?>
            <div class="<?= ($source == 'index') ? 'wrap-home wrap-low' : 'wrap-main' ?> w-clear"><?php include TEMPLATE . $template . "_tpl.php"; ?></div>
            <?php
            ...
            if(isset($js_template)&&$js_template!=''){
                include TEMPLATE . LAYOUT .$js_template. "_js.php";
            }   
