				...
				<div class="row">
					...
					<?php } else { ?>
						<div class="form-group col-xl-4 col-lg-6 col-md-6">
							...
							<input type="text" class="form-control" name="data[username]" id="username" placeholder="Tài khoản" value="<?= @$item['username'] ?>" required readonly>
						</div>
						<div class="form-group col-xl-4 col-lg-6 col-md-6">
							<label for="ten">Họ tên: <span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="data[ten]" id="ten" placeholder="Họ tên" value="<?= @$item['ten'] ?>" required readonly>
						</div>
						<!-- <div class="form-group col-xl-4 col-lg-6 col-md-6">
						...
						<div class="form-group col-md-4">
							<label for="thoihan">Thời hạn: <span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="" id="thoihan" placeholder="Thời hạn" value="<?= (@$item['thoihan']) ? date('d/m/Y', @$item['thoihan']) : ""; ?>" readonly>
						</div>
						<!-- <div class="form-group col-md-4">
							<label for="diachi">Tỉnh/Thành phố: </label>
							<?= $func->get_ajax_place("city", 'Chọn danh mục', $func->getAdminCurrent($_SESSION[$login_admin]['id'])['id_city']) ?>
						</div>
						<div class="form-group col-md-4">
							<label for="diachi">Xã/Phường:</label>
							<?= $func->get_ajax_place("wards", 'Chọn danh mục', $func->getAdminCurrent($_SESSION[$login_admin]['id'])['id_wards']) ?>
						</div> -->
						...
						<div class="form-group col-md-12">
							...
							<input type="text" class="form-control" name="data[toado]" id="toado" placeholder="Link google map" value="<?= @$item['toado'] ?>" readonly>
						</div>
						<div class="form-group col-md-12">
							<label for="toado_iframe">iframe map:</label>
							<textarea name="data[toado_iframe]" readonly class="form-control" id="toado_iframe" placeholder="iframe map" rows="5"><?= htmlspecialchars_decode($item['toado_iframe']) ?></textarea>
						</div>
					<?php } ?>
				</div>
			</div>
